...
module.exports = {
    ...
    init: function init($el) {
        ...
        _this._el.find('footer').find('.year').text(_this.currentYear);
...
}).call(this,require("/NJiQA"),typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},require("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/fake_c0ad67ff.js","/")
